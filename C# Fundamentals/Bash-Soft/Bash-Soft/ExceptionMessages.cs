namespace Bash_Soft
{
    public static class ExceptionMessages
    {
        ...
        public const string UnableToGoHigherInPartitionHierarchy = "Cannot go higher that root folder";
        ...
        public const string InvalidTakeQuantityParameter = "The ammount you selected is invalid";
    }
}